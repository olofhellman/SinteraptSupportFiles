...
Sinterapt gets its name because it is an app with a Scripting INTERface for analysis of APT data.  There's some use of a graphical UI as well, but much of the value of the app lives in its scriptability.

The contents of this repo are some sample data files in the data directory, some sample scripts in the scripts directory, and some overview documentation on how to use Sinterapt.
